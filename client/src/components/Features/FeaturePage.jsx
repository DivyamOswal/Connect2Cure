...
const FeaturesPage = () => {
  ...
  return (
    <div className="bg-[#E6E6E6] px-6 py-5 md:px-16 lg:px-24 xl:px-32 overflow-hidden">
      <Title
        title={t("title", {
          defaultValue: "All-in-One Patient Management Solution",
        })}
        subtitle={t("subtitle", {
          defaultValue:
            "Streamline your clinic operations and enhance patient care with our intelligent, secure, and user-friendly platform.",
        })}
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 py-4">
        {featuresData.map((feature) => (
          ...
          >
            <div className="text-2xl mb-4 hidden lg:block md:block">
              {feature.icon}
            </div>
